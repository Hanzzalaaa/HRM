...
const MIN_WORK_SECONDS = 3 * 60 * 60
...
// ✅ PKT (UTC+5) mein aaj ki date — midnight issue fix
...
export function EmployeeAttendanceView({ attendance, employeeId, shiftHours = 9 }: EmployeeAttendanceViewProps) {
  ...
  // ✅ Client side PKT date set karo
  useEffect(() => {
    setTodayLocal(getPKTToday())
  }, [])
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{todayLocal ? formatDate(todayLocal) : ""}</CardDescription>
        </CardHeader>
